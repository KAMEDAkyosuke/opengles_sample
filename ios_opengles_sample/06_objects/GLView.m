...
static float model_position[20][3];
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        for(int i=0; i<20; i++){
            model_position[i][0] = cos(arc4random()) * 3;
            model_position[i][1] = cos(arc4random()) * 5;
            model_position[i][2] = cos(arc4random()) * 10;
        }
    }
    return self;
}
...
- (void)render:(CADisplayLink*)displayLink
{
    ...
    // camera
    {
        ...
        camera = GLKMatrix4Translate(camera, 0, 0, -30.0f);
    ...
    for(int i=0; i<20; ++i){
        ...
        {
            GLKMatrix4 modelView = GLKMatrix4Identity;
            modelView = GLKMatrix4Translate(modelView,
                                            model_position[i][0],
                                            model_position[i][1],
                                            model_position[i][2]);
